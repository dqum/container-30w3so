...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-30w3so.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-30w3so.containers.anotherwebservice.com/
...
```
git clone git@github.com:dqum/container-30w3so.git
cd container-30w3so
```
...
```
docker attach container-30w3so
```
